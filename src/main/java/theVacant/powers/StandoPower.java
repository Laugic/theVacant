...
public class StandoPower extends AbstractPower implements CloneablePowerInterface, OnPlayerDeathPower
{
    public AbstractCreature source;

    public static final String POWER_ID = VacantMod.makeID(StandoPower.class.getSimpleName());
    ...
    public StandoPower(final AbstractCreature owner, final AbstractCreature source, final int amount)
    {
        name = NAME;
        ID = POWER_ID;
