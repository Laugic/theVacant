...
public class ExorcisePower extends AbstractPower implements CloneablePowerInterface
{
    public AbstractCreature source;

    public static final String POWER_ID = VacantMod.makeID(ExorcisePower.class.getSimpleName());
    ...
    {
        return new ExorcisePower(owner, source, amount);
    }
}
