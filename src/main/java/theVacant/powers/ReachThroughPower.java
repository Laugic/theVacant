...
public class ReachThroughPower extends AbstractPower implements CloneablePowerInterface
{
    public AbstractCreature source;

    public static final String POWER_ID = VacantMod.makeID(ReachThroughPower.class.getSimpleName());
    ...
    {
        return new ReachThroughPower(owner, source, amount);
    }
}
