...
public class ForgeSoulPower extends AbstractPower implements CloneablePowerInterface
{
    public AbstractCreature source;

    public static final String POWER_ID = VacantMod.makeID(ForgeSoulPower.class.getSimpleName());
...
*/
    ...
    {
        return new ForgeSoulPower(owner, source, amount);
    }
}
