...
public class OpalOption  extends AbstractDynamicCard
{
    public static final String ID = VacantMod.makeID(OpalOption.class.getSimpleName());
    ...
    {
        addToTop(new MineGemAction(new OpalOrb(magicNumber)));
    }
